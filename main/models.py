...
class Task(models.Model):
    ...
    created_at = models.DateTimeField(verbose_name ='Даалгавар үүссэн огноо', auto_now_add=True, null=True, blank=True)
    updated_at = models.DateTimeField(verbose_name ='Даалгавар шинэчилсэн огноо', auto_now=True, null=True, blank=True)
